export module pocket.highestpop;

export import pocket.bitarr;

export namespace kuma
{
	constexpr bitarr8_t highestPop(bitarr8_t n)noexcept
	{
		n = (n & 0xf0U) ? (n & 0xf0U) : n;
		n = (n & 0xccU) ? (n & 0xccU) : n;
		n = (n & 0xaaU) ? (n & 0xaaU) : n;
	...
	constexpr bitarr16_t highestPop(bitarr16_t n)noexcept
	{
	...
	constexpr bitarr32_t highestPop(bitarr32_t n)noexcept
	{
	...
	constexpr bitarr64_t highestPop(bitarr64_t n)noexcept
	{
